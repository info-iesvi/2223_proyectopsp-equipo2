...
public class TopPositiveReview {
    ...
    @Expose
    private Variation__1 variation;
     ...
     * @param username
     */
    public TopPositiveReview(Object stars, String date, boolean verifiedPurchase, boolean manufacturerReplied, String username, String title, String review, Object totalFoundHelpful, List<Object> images, Variation__1 variation, Object videoUrl) {
        super();
        this.stars = stars;
        this.date = date;
    ...
    public Variation__1 getVariation() {
        return variation;
    }

    public void setVariation(Variation__1 variation) {
        this.variation = variation;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TopPositiveReview) == false) {
            return false;
        }
        TopPositiveReview rhs = ((TopPositiveReview) other);
